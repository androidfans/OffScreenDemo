 ...
 * 高斯模糊滤镜
 */
public class GLImageGaussianBlurGPUImageFilter extends GLImageFilter {

    protected GLImageGaussPassHighPerfFilter mVerticalPassFilter;
    protected GLImageGaussPassHighPerfFilter mHorizontalPassFilter;

    private int mCurrentTexture;

    public GLImageGaussianBlurGPUImageFilter(Context context) {
    ...
    private void initFilters() {
        mVerticalPassFilter = new GLImageGaussPassHighPerfFilter(mContext);
        mHorizontalPassFilter = new GLImageGaussPassHighPerfFilter(mContext);
        setBlurSize(1.0f);
    }
    ...
    public void setBlurSize(float blurSize) {
        ...
        onInputSizeChanged(MainActivity.Width, MainActivity.Height);
    }
